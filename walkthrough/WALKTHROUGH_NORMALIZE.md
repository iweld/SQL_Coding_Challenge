...
The data has been 'cleaned' and is now in a more usable form.  We also note that there are duplicate entries.   Before removing any duplicates, let's continue cleaning the data and adding our clean tables into our `normalize_table.sql` script. 
